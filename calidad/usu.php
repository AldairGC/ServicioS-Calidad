...
echo "<table width='100%' border=3 bordercolor='#19070B'>";
              ...
              echo "<tr>";
              echo "<td bgcolor=ffffff><img src=logo.jpg hspace='20'><font size='2' face='arial'><h5><b><center>UNIVERSIDAD TECNOLOGICA DE PUEBLA  / ACCION PREVENTIVA</td>";
              echo "</tr>";
              echo "</table>";
...
while($row=mysql_fetch_array($consulta))
	{
              ...
              echo "<table width='100%' border=3 bordercolor='#19070B'>";
              echo "<tr>";
              echo "<td bgcolor=#E6E6E6><h3><b><font size='3' face='arial'>1.- Declaración de la no Conformidad Potencial</td>";
              ...
              echo "<td bgcolor=#E6E6E6><font size='1' face='arial'><h3><b>Detectada en:<u>$dete:<u>$dete1:<u>$dete2:<u>$dete3:<u>$dete4<br>Otra:$otra</td>";
              ...
              //echo "<tr>";
              //echo "<td></td>";
              //echo "<td bgcolor=ffffff><h3><b><font size='1' face='arial'>Otra:$otra</td>";
              //echo "</tr>";
              echo "</table>";
              ...
              echo "<table width='100%' border=3 bordercolor='#19070B'>";
              echo "<tr>";
              echo "<td><font size='1' face='arial'><textarea rows=3 cols=40>$efectivo</textarea></td>";
              ...
              echo "<table width='100%' border=3 bordercolor='#19070B'>";
              echo "<tr>";
              echo "<td><font size='1' face='arial'><textarea rows=3 cols=40>$veriefectivo</textarea></td>";
