...
echo "<center><table border=1 width=15%>";
echo "<tr><td align=center bgcolor=324D8A colspan=2>ACCION CORRECCION No: $idco</td></tr><tr>";

echo "<td><input type='submit' class='boot' name='guarda' value='FRENTE' onClick=window.open('rootimprecorre.php?idco=$idco','_blank')>";
