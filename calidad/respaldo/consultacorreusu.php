...
<center>
				 <table width="45%" height="15%" border="5px" bordercolor="black">
              			 <tr>
             			 <form action=consultacorreusu1.php method=post>
                               	<td><b><center>Usuario: <input type=password name=va2 maxlength=10>
              ...
              <?php
                                ...
                                echo "<td><b><center>Password:<input type=password name=va1 maxlength=10> ";
