...
echo "<form action=horacorrectiva1.php method=post>";
...
echo "<b><h2><center>fecha al dia de Hoy: $fechaactual<br><br<br>Acciones Correctivas</h2><center><img src='rojo.jpg'>Vencida<img src='amarillo.jpg'>Pendiente<br>";
