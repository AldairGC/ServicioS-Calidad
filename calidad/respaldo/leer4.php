...
echo "<center><b><h2>Listado de Evidencias de Acciones Preventivas de todos los Auditores</h2>";  
...
$x=$x+1;
echo "<tr><td>$x</td>";  
echo "<td><a href='tmp4/$archivo' target='_blank'><b>$nombreArch</b></a><br></td><td><a href='./borrar4.php?fichero=$nombreArch' target='_blank'> Borrar </a></td></tr>";        
