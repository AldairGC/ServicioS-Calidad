...
<input type=hidden name=fechaveri value=''>
	...
	<center><table border="1" width=50% color=black>
		<tr>
		<td align=center><center><font size="4" color="#000000" face="Arial, Helvetica, sans-serif"><B>ACCION CORRECTIVA</B></font></center></td>
		</tr>
        </table>
...
mysql_close($link);
		...
		<td>Causas: <input type=text name=causa1 value=1><input type=text name=causa2 value=2><input type=text name=causa3 value=3></td>
                ...
                <tr>
		<td>Subcausa: <textarea name=subcausa1 cols=10 rows=10>1</textarea><textarea name=subcausa2 cols=10 rows=10>2</textarea><textarea name=subcausa3 cols=10 rows=10>3</textarea></td>
		...
		<td>Subcausa: <textarea name=subcausa4 cols=10 rows=10>4</textarea><textarea name=subcausa5 cols=10 rows=10>5</textarea><textarea name=subcausa6 cols=10 rows=10>6</textarea></td>
		</tr>
