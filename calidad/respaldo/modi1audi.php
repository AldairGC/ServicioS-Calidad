...
$fechaveri=$_POST['fechaveri'];
				...
				mysql_query("UPDATE ac SET efectivo='$efectivo', auditorarea='$auditorarea', fechaarea='$fechaarea', veriefectivo='$veriefectivo', auditorveri='$auditorveri', fechaveri='$fechaveri' WHERE idac='$idac'",$link);
