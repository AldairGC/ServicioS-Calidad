...
<form action=insertapreusu.php method=post>
...
<input type=hidden name=fechaveri value=''>
	...
	<center><table border="1" width=50%>
		<tr>
		<center><td align=center><font size="4" color="#000000" face="Arial, Helvetica, sans-serif"><B>ACCION PREVENTIVA DEL USUARIO</B></font></center></td>
		</tr>
		</center>
        </table>
	<table border="1" width=50%>
		<tr bgcolor='#848484'>
		<td align=center width=800><font color="#FFFFFF">1.- Declaracion de la No Conformidad Potencial</font></td>
...
mysql_close($link);
		...
		<td></td>
                ...
                <tr bgcolor='#848484'><td></td>
		<td align=center width=800><font color="#FFFFFF">3.- Resultado del Analisis de Causa Raiz de la NCP</font></td>
                <td></td>
		</tr>
                <tr>
		<td></td>
        ...
        <table border="1" width=70%>
                ...
                <tr>
		<td><b>Analisis de Causa Efecto</td>
		</tr>
        </table>
        <table border="1" width=70%>
                <tr>
		<td>Causas: <input type=text name=causa1 value=1><input type=text name=causa2 value=2><input type=text name=causa3 value=3></td>
                ...
                <tr>
		<td>Subcausa: <textarea name=subcausa1 cols=16 rows=10></textarea><textarea name=subcausa2 cols=16 rows=10></textarea><textarea name=subcausa3 cols=16 rows=10></textarea></td>
		...
		<td>Subcausa: <textarea name=subcausa4 cols=16 rows=10></textarea><textarea name=subcausa5 cols=16 rows=10></textarea><textarea name=subcausa6 cols=16 rows=10></textarea></td>
		</tr>
