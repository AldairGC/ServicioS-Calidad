...
echo "<b><h2><center>fecha al dia de Hoy: $fechaactual<br><br<br>Acciones Preventivas</h2><center><img src='rojo.jpg'>Vencida<img src='amarillo.jpg'>Pendiente<img src='verde.jpg'>Cerrada<br>";
                                ...
                                if($x==1 or $y==1)
                                 {
                                   ...
                                   if($fechaveri=='0000-00-00'){echo "</tr>";}
                                      ...
                                      echo "<form action=cierre1.php?c=2 method=post>";
