...
echo "<center><b><h2>Listado de Evidencias de Acciones Correctivas del Administrador</h2>";  
...
$x=$x+1;
echo "<tr><td>$x</td>";
echo "<td><a href='tmp6/$archivo' target='_blank'><b>$nombreArch</b></a><br></td><td><a href='./borrar2.php?fichero=$nombreArch' target='_blank'> Borrar </a></td></tr>";          
