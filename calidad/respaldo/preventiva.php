...
<br><br><br><br><br>
<form action=insertapre.php method=post>
...
<input type=hidden name=fechaveri value=''>
	...
	<center><table border="1" width=50%>
		<tr>
		<td align=center><center><font size="4" color="#000000" face="Arial, Helvetica, sans-serif"><B>Accion Preventiva</B></font></center></td>
		</tr>
        </table>
...
mysql_close($link);
		...
		<td align=center width=800><font color="#FFFFFF">2.- Accion Inmediata</font></td>
                ...
                <tr>
		<td></td>
		<td><textarea name=accionin cols=40 rows=5 maxlength=300></textarea></td>
		<td></td>
		</tr>
                <tr bgcolor="#848484"><td></td>
		<td align=center width=800><font color="#FFFFFF">3.- Resultado del Analisis de Causa Raiz de la NCP</font></td>
                ...
                <tr>
		<td></td>
		<td><textarea name=resultado cols=40 rows=5 maxlength=300></textarea></td>
		<td></td>
		</tr>
		<tr bgcolor="#848484">
		<td></td>
		...
		<td>Subcausa: <textarea name=subcausa4 cols=16 rows=10>4</textarea><textarea name=subcausa5 cols=16 rows=10>5</textarea><textarea name=subcausa6 cols=16 rows=10>6</textarea></td>
                ...
                <tr>
		<td>Efecto: <input type=text name=efecto size=100></td>
		</tr>
        </table>
