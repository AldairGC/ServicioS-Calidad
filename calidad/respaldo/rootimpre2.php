<STYLE type="text/css">
.formato {width:680px;height:70px;border:}
</STYLE>
<script>
...
echo "<table width='100%' border=1 bordercolor='black'>";
              ...
              echo "<tr>";
              echo "<td><h5><b><img src=logo.jpg hspace='20'><center><font size='1' face='arial'>UNIVERSIDAD TECNOLOGICA DE PUEBLA <br>ACCION PREVENTIVA</td>";
              echo "</tr>";
              echo "</table>";
...
while($row=mysql_fetch_array($consulta))
	{
              ...
              echo "<table width='100%' border=1 bordercolor='black'>";
              echo "<tr>";
              echo "<td><h3><b><font size='3' face='arial'>1.- Declaración de la no Conformidad</td>";
              echo "<td><h3><b><center><font size='1' face='arial'>Folio:$folio</td>";
              echo "</tr>";
              echo "<tr>";
              echo "<td><h3><b><font size='1' face='arial'>$conforme</td>";
              echo "<td><h3><b><font size='1' face='arial'>Detectada en:<u>$dete:<u>$dete1:<u>$dete2:<u>$dete3:<u>$dete4<br>Otra:$otra</td>";
              ...
              echo "<table width='100%' border=1 bordercolor='black'>";
              echo "<tr>";
              echo "<td align=center><b><font size='1' face='arial'>Fecha de Notificación:$fechanoti</td>";
              echo "<td align=center><b><font size='1' face='arial'>Area 1:$area Responsable:$nombreres</td>";
              echo "<td align=center><b><font size='1' face='arial'>Auditor del Area:</td>";
              echo "</tr>";
              echo "<tr>";
              echo "<td><font size='1' face='arial'></td>";
              echo "<td align=center><b><font size='1' face='arial'>Area 2:$area1 Responsable:$nombreres1</td>";
              echo "<td align=center><font size='1' face='arial'>$auditor</td>";
              echo "</tr>";
              echo "<tr>";
              echo "<td align=center><font size='1' face='arial'>$nombreno</td>";
              echo "<td align=center><b><font size='1' face='arial'>Area 3:$area2 Responsable:$nombreres2</td>";
              echo "<td align=center><font size='1' face='arial'>$nombre</td>";
              echo "</tr>";
              echo "<tr>";
              echo "<td align=center><b><font size='1' face='arial'>Nombre y Firma de quien informa la No Conformidad:</td>";
              echo "<td align=center><b><font size='1' face='arial'>Area 4:$area3 Responsable:$nombreres3</td>";
              echo "<td align=center><b><font size='1' face='arial'>Nombre y Firma:</td>";
              echo "</tr>";
              ...
              echo "<table width='100%' border=1 bordercolor='black'>";
              echo "<tr>";
              echo "<td align=left><b><font size='3' face='arial'>2.- Accion Inmedita:</td>";
              echo "</tr>";
              echo "<tr>";
              echo "<td><font size='1' face='arial'><textarea class=formato cols=100 rows=3>$accionin</textarea></td>";
              echo "</tr>";
              echo "<tr>";
              echo "<td align=left><b><font size='3' face='arial'>3.- Resultado del Análisis de Causa Raíz de la NC (Utilizar Técnicas al 
              Reverso):</td>";
              echo "</tr>";
              echo "<tr>";
              echo "<td><font size='1' face='arial'><textarea class=formato cols=100 rows=3>$resultado</textarea></td>";
              echo "</tr>";
              echo "<tr>";
              echo "<td align=left><b><font size='3' face='arial'>4.- Acciones a implantar para asegurar que no vuelva a ocurrir la No Conformidad:</td>";
              echo "</tr>";
              echo "</table>";
              echo "<table width='100%' border=1 bordercolor='black'>";
              ...
              echo "<tr>";
              echo "<td align=center><b><font size='1' face='arial'>Acciones:</td>";
              echo "<td align=center><b><font size='1' face='arial'>Responsables:</td>";
              echo "<td align=center><b><font size='1' face='arial'>Fecha:</td>";
              echo "</tr>";
              ...
              echo "<table width='100%' border=1 bordercolor='black'>";
              echo "<tr>";
              echo "<td align=left><b><font size='3' face='arial'>5.- Efectividad de la Implantación:</td>";
              echo "</tr>";
              echo "</table>";
              echo "<table width='100%' border=1 bordercolor='black'>";
              echo "<tr>";
              echo "<td><font size='1' face='arial'>Que acciones se implantaron:</td>";
              echo "<td></td>";
              echo "</tr>";
              echo "<tr>";
              ...
              echo "<table width='100%' border=1 bordercolor='black'>";
              echo "<tr>";
              echo "<td><font size='1' face='arial'>Verificacion de la efectividad:</td>";
              echo "<td></td>";
              echo "</tr>";
              echo "<tr>";
