...
echo "<input type=button value='Imprimir Frente' onClick=window.open('rootimpre2.php?idac=$idac','_blank')>";
echo "<input type=button value='Imprimir Reverso' onClick=window.open('rootimpre21.php?idac=$idac','_blank')>";
?>
