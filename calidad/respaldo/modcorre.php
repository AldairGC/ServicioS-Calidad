...
$fecha=$_POST['fecha'];
				...
				mysql_query("UPDATE corre SET idco='$idco', nomdoc='$nomdoc', folio='$folio', codigo='$codigo', hallazgo='$hallazgo', notifica='$notifica', area='$area', area1='$area1', area2='$area2', area3='$area3', lider='$lider', nomhalla='$nomhalla', nomres='$nomres', descrip='$descrip', accion='$accion', audito='$audito', fecha='$fecha' WHERE idco='$idco'",$link);
