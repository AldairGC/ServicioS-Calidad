...
echo "<center><b><h2>Listado de Evidencias de Acciones Correctivas de todos los Usuarios</h2>";  
...
echo "<tr><td>$x</td>";    
echo "<td><a href='tmp/$archivo' target='_blank'><b>$nombreArch</b></a><br></td><td><a href='./borrar.php?fichero=$nombreArch' target='_blank'> Borrar </a></td></tr>";     
