...
echo "<center><b><h2>Listado de Evidencias de Acciones Correccion del Administrador</h2>";  
...
$x=$x+1;
echo "<tr><td>$x</td>";     
echo "<td><a href='tmp8/$archivo' target='_blank'><b>$nombreArch</b></a><br></td><td><a href='./borrar8.php?fichero=$nombreArch' target='_blank'> Borrar </a></td></tr>";     
