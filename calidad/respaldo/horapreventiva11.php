...
echo "<form action=horapreventiva11.php method=post>";
...
echo "<b><h2><center>fecha al dia de Hoy: $fechaactual<br><br<br>Acciones Preventivas</h2><center><img src='rojo.jpg'>Vencida<img src='amarillo.jpg'>Pendiente";
...
include('conecta.php');
             ...
             echo "<center><table width=30% border=4px bordercolor=black>";
              echo "<tr>";
