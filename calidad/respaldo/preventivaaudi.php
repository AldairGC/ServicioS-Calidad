...
<form action=insertapreaudi.php method=post>
...
<input type=hidden name=fechaveri value=''>
	...
	<center><table border="1" width=50%>
		<tr>
		<center><td align=center><font size="4" color="#000000" face="Arial, Helvetica, sans-serif"><B>ACCION PREVENTIVA</B></font></center></td>
		</tr>
        </table>
	<center><table border="1" width=50%>
		<tr bgcolor='#848484'>
		<td><font color="#FFFFFF">1.- Declaracion de la No Conformidad Potencial</font></td>
