...
while($row=mysql_fetch_array($consulta))
	{
              ...
              echo "<tr>";
              echo "<td><font size='1' face='Arial'><textarea rows=20 cols=20>$porque1</textarea></td>";
              echo "<td><font size='1' face='Arial'><textarea rows=20 cols=20>$porque2</textarea></td>";
              echo "<td><font size='1' face='Arial'><textarea rows=20 cols=20>$porque3</textarea></td>";
              echo "<td><font size='1' face='Arial'><textarea rows=20 cols=20>$porque4</textarea></td>";
              echo "<td><font size='1' face='Arial'><textarea rows=20 cols=19>$porque5</textarea></td>";
              echo "</tr>";
              echo "</table>";
              echo "<table width='100%' border=3 bordercolor='#19070B'>";
              echo "<tr>";
