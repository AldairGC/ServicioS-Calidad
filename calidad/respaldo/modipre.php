...
<br><br><br><br><br>
              ...
              <?php
                                 echo "<form action=modi1pre.php method=post>";
...
include('conecta.php');
       ...
       echo " </table>";
		...
		echo "<td><textarea rows=20 cols=15 name=porque5 maxlength=200>$porque5</textarea></td>";
		echo "</tr>";
        echo "</table>";
       echo " <table border='1' width=70%>";
        ...
        echo "<table border='1' width=70%>";
                echo "<tr>";
		echo "<td><textarea rows=20 cols=100 maxlength=1500 name=otratec>$otratec</textarea></td>";
		echo "</tr>";
        echo "</table>";
