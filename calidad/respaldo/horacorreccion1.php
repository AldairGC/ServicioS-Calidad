...
echo "<form action=horacorreccion1.php method=post>";
				  ...
				  echo "<td align=center><b><form action=modico.php method=post target=blanck><input type=hidden name=idco value=$idco><input type=image src='rojo.jpg'></form></td>"; 
                             ...
                             if($y==1)
                                ...
                                { 
                                  ...
                                  echo "<td>$idco</td><td align=center><b><form action=modico.php method=post target=blanck><input type=hidden name=idco value=$idco><input type=image src='amarillo.jpg'></form></td></form>";
