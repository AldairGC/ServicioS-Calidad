...
echo "<form action=horapreventiva1.php method=post>";
...
echo "<b><h2><center>fecha al dia de Hoy: $fechaactual<br><br<br>Acciones Preventivas</h2><center><img src='rojo.jpg'>Vencida<img src='amarillo.jpg'>Pendiente<br>";
...
include('conecta.php');
				...
				$consul=mysql_query("SELECT * FROM areas where usuauditor='$usuario'",$link);
				...
				$consulta=mysql_query("SELECT * FROM ap where auditor='$nomcal'",$link);
              ...
              if($x==1 or $y==1)
                 {
                      ...
                      if($x==1)                     
                         {
                                  echo "<tr><td>$idac</td>";
				  echo "<td align=center><b><form action=modisp.php method=post target=blanck><input type=hidden name=idac value=$idac><input type=image src='rojo.jpg'></form></td>"; 
                             ...
                             if($y==1)
                                ...
                                { 
                                  ...
                                  echo "<td>$idac</td><td align=center><b><form action=modisp.php method=post target=blanck><input type=hidden name=idac value=$idac><input type=image src='amarillo.jpg'></form></td></form>";
                      ...
                      if($x==1)                     
                         {
                             ...
                             if($y==1)
                                ...
                                { 
                                  echo "<form action=modisp.php method=post target='_blank'>";
                                 if($resta<=5)
                                 {
