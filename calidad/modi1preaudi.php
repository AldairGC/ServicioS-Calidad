...
$fechaveri=$_POST['fechaveri'];
	...
	mysql_query("UPDATE app SET efectivo='$efectivo', auditorarea='$auditorarea', fechaarea='$fechaarea', veriefectivo='$veriefectivo', auditorveri='$auditorveri', fechaveri='$fechaveri' WHERE idac='$idac'",$link);
				
			        echo "<font color=#324D8A size=2><b><center>Se ha Modificado la Informacion correctamente......</td>";   
