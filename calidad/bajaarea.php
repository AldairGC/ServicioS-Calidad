...
while($row=mysql_fetch_array($consulta))
			  {
			    $idarea=$row['idarea'];
                 ...
                 if($idarea=$numero)
                          {
                            mysql_query("DELETE FROM areas1 WHERE idarea='$idarea'",$link); 
                            echo "<td bgcolor=ffffff align=center><b><font size=3 color=#324D8A>Se ha borrado el registro de la Base de Datos</td>";
                           }
                         else
                          {
