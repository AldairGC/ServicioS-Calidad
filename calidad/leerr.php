...
$directorio = opendir("tmp3/");
echo "<center><b><h2><font color=#324D8A>Listado de Evidencias de Acciones Correctivas de todos los Usuarios</h2>";  
...
echo "<tr><td><font color=#324D8A>$x</td>";    
echo "<td><a href='tmp3/$archivo' target='_blank'><b><font color=#324D8A>$nombreArch</b></a><br></td><td><a href='./borrar.php?fichero=$nombreArch' target='_blank'><font color=#324D8A> Borrar </a></td></tr>";     
