...
echo "<form action=horacorrectiva-usu.php method=post>";
?>
...
echo "<b><h2><center><font color=#324D8A>fecha al dia de Hoy: $fechaactual<br><br><br>Acciones Correctivas</h2><center><img src='rojo.jpg'>Vencida<img src='amarillo.jpg'>Pendiente";
...
include('conecta.php');
				...
				$consulta=mysql_query("SELECT * FROM acc where auditor='$nomcal'",$link);
