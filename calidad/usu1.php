...
while($row=mysql_fetch_array($consulta))
	{
              ...
              echo  "<tr>";
              echo  "<td align=center bgcolor=#E6E6E6><b><font size='3' face='arial'>Utilice alguna de las siguientes técnicas para el análisis de la Causa - Raíz de la No Conformidad:</td>";
              echo  "</tr>";
              echo  "</table>";

              echo  "<table width='100%' border=3 bordercolor='#19070B'>";
              echo  "<tr>";
              echo  "<td align=left bgcolor=#E6E6E6><b><font size='3' face='arial'>A) Técnica de los 5 por ques:</td>";
              echo  "</tr>";
              echo  "</table>";
              ...
              echo  "</tr>";
              echo  "<tr>";
              echo  "<td><font size='1' face='arial'>$porque1</td>";
              echo "<td><font size='1' face='arial'>$porque2</td>";
              echo "<td><font size='1' face='arial'>$porque3</td>";
              echo "<td><font size='1' face='arial'>$porque4</td>";
              echo "<td><font size='1' face='arial'>$porque5</td>";
              echo  "</tr>";
              echo  "</table>";
              echo  "<table width='100%' border=3 bordercolor='#19070B'>";
              echo  "<tr>";
              echo  "<td align=left bgcolor=#E6E6E6><b><font size='3' face='arial'>B) Técnica de Causa - Efecto:</td>";
              echo  "</tr>";
              echo  "</table>";
              echo  "<table width='100%' border=3 bordercolor='#19070B'>";
              echo  "<tr>";
              ...
              echo  "<table width='100%' border=3 bordercolor='#19070B'>";
              echo  "<tr>";
              echo  "<td align=left bgcolor=#E6E6E6><b><font size='3' face='arial'>C) Cualquier otra Técnica de su Elección:</td>";
              echo  "</tr>";
              echo  "</table>";
              echo  "<table width='100%' border=3 bordercolor='#19070B'>";
              echo  "<tr>";
