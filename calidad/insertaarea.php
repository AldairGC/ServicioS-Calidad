...
<div id="templatemo_content">
	...
	<center><table width="70%" border="2px" bordercolor="black">
              	<tr>
<?php
...
mysql_query("INSERT INTO areas1(clave,nomarea,nomcal,titu,usuauditor,passauditor,usuusu,passusu) VALUES ('$clave','$nomarea','$nomcal','$titu','$usuauditor','$passauditor','$usuusu','$passusu')",$link); 
echo "<td></td>";
echo "<td bgcolor=white><b><center><font size=3 color=#324D8A>Se han insertado correctamente los datos a la Base de Datos...</center></td>";
echo "<td></td>";
echo "</table>";
echo "<br><br>";
