...
echo "<td><input type='submit' class='boot' name='guarda' value='FRENTE' onClick=window.open('usu.php?idac=$idac','_blank')>";
echo "<td><input type='submit' class='boot' name='guarda' value='REVERSO' onClick=window.open('usu1.php?idac=$idac','_blank')>";
?>          
</table>
