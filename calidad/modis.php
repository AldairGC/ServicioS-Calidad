...
include('conecta.php');
		...
		echo "</tr>";
                echo "<tr>";
		echo "<td></td><td><input type='checkbox'  name='dete' value='Auditoria Interna'> Auditoria Interna</td></tr><tr>";
		echo "</tr>";
                echo "<tr>";
...
include('conecta.php');
		...
		echo "<td><textarea rows=20 cols=10 name=porque5>$porque5</textarea></td>";
		echo "</tr>";
        echo "</table>";
