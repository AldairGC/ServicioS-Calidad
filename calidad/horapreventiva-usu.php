...
echo "<form action=horapreventiva-usu.php method=post>";
?>
...
echo "<b><h2><center><font color=#324D8A>fecha al dia de Hoy: $fechaactual<br><br><br>Acciones Preventivas</h2><center><img src='rojo.jpg'>Vencida<img src='amarillo.jpg'>Pendiente";
...
include('conecta.php');
				...
				$consul=mysql_query("SELECT * FROM areas1 where usuusu='$var2'",$link);
				...
				$consulta=mysql_query("SELECT * FROM app where auditor='$nomcal'",$link);
