...
function editar(idco){
	window.location="modicorr.php?idco="+idco;
}
function imprime(idco){
	window.location="impre2correusu.php?idco="+idco;
}
...
<div id="templatemo_content">
	...
	<div id="main_column">
    	...
    	<div class="section_w500">
             ...
             <center><h3><font color=#324D8A>Lista de acciones corrección Levantadas por el Auditor</h3><br><br>
...
if($x==1)
{
				...
				$consulta=mysql_query("SELECT * FROM corres WHERE area='$nomarea' or area1='$nomarea' or area2='$nomarea' or area3='$nomarea'",$link);
...
<?php
		...
		echo '</td>';
             ...
             <center><h3>Lista de acciones corrección Levantadas por el Usuario</h3><br><br>
             ...
             <center><table width="40%" border="1px" bordercolor="black">
              ...
              <?php
				...
				$consulta=mysql_query("SELECT * FROM corres WHERE var1='$var1' and auditor<>'$nomcal' order by auditor",$link);
				while($row=mysql_fetch_array($consulta))
				{
					$idco=$row['idco'];
					$conforme=$row['conforme'];
