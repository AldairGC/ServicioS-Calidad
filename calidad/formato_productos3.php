...
<div id="templatemo_content">
	...
	<table border="1" width=50% color=black >
		<tr>
		<td align=center><center><font size="4" color="#000000" face="Arial, Helvetica, sans-serif">SUBIR EVIDENCIAS CORRECTIVA</font></center></td>
		</tr></table>
        <br>
...
if ($_GET["subir"]=="1")
{
	$uploaddir = "tmp3/";
	 ...
	 if(isset($_POST['boton']) && $error==UPLOAD_ERR_OK) { 
	   ...
	   rename("tmp3/".basename($_FILES['archivo']['name']), "tmp3/".$filename);
	   //echo "tmp3/".$filename;
	  } 
	   if($subido) { 
...
if ($_GET["borrar"]=="1")
{
	unlink("tmp3/".$_GET["nombre_archivo"]);
...
?>
                    ...
                    <form action="formato_productos3.php?id=<?= $_GET["id"] ?>&folio=<?= $mirow[0] ?>&subir=1" method="post" enctype="multipart/form-data" name="form"> 
