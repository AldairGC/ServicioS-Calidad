...
mysql_query("INSERT INTO corres(nomdoc,folio,codigo,hallazgo,notifica,area,lider,nomhalla,nomres,descrip,accion,audito,fecha,tipo,var1,var2) VALUES ('$nomdoc','$folio','$codigo','$hallazgo','$notifica','$area','$lider','$nomhalla','$nomres','$descrip','$accion','$audito','$fecha','$tipo','$var1','$var2')",$link); 
echo "<center><b><font color=#324D8A>Se han insertado correctamente los datos a la Base de Datos...</center></td>";
echo "<br><br>";
