...
<div id="templatemo_content">
  ...
  <br>
	...
	<center><table border="1" width=50% color=black >
		<tr>
		<td align=center><center><font size="4" color="#000000" face="Arial, Helvetica, sans-serif">CONSULTA ACCION CORRECTIVA</font></center></td>
		</tr>
        </table><br>
...
<?php 
echo "<td><b>";
echo $PAGINADOR->ver_pagina("consulta.php");
echo "</td></b>";
?>
</div>
</tr>
