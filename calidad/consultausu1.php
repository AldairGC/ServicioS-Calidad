...
function editar(idac){
	window.location="modiusu.php?idac="+idac;
}
function imprime(idac){
	window.location="impre2usu.php?idac="+idac;
}
...
<div id="templatemo_content">
	...
	<div id="main_column">
    	...
    	<div class="section_w500">
             ...
             <center><h3><font color=#324D8A>Lista de acciones correctivas Levantadas por el Auditor</h3><br><br>
...
if($x==1)
{
				...
				$consulta=mysql_query("SELECT * FROM acc WHERE area='$nomarea' or area1='$nomarea' or area2='$nomarea' or area3='$nomarea'",$link);
...
include('conecta.php');
				...
				$consulta=mysql_query("SELECT * FROM acc WHERE var1='$var1' and auditor<>'$nomcal' order by auditor",$link);
				while($row=mysql_fetch_array($consulta))
				{
					$idac=$row['idac'];
					$conforme=$row['conforme'];
