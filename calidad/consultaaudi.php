...
function editar(idac){
	window.location="modiaudi.php?idac="+idac;
}
function imprime(idac){
	window.location="impre2audi.php?idac="+idac;
}
...
?>
  ...
  <br>
	...
	<center><table border="1" width=50% color=black >
		<tr>
		<td align=center><center><font size="4" color="#000000" face="Arial, Helvetica, sans-serif">CONSULTA ACCION CORRECTIVA Auditor:  <?php echo $nomcal; ?></font></center></td>
		</tr>
        </table><br>
...
include("class.pagina.php");
              ...
              $sql="select * from acc where auditor='$nomcal'";
...
<?php 
echo "<td><b>";
echo $PAGINADOR->ver_pagina("consultaaudi.php");
echo "</td></b>";
?>
</div>
</tr>
