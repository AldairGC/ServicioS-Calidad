...
function editar(idac){
	window.location="modipre.php?idac="+idac;
}
function imprime(idac){
	window.location="impre2pre.php?idac="+idac;
}
function eliminar(idac){
        var mensaje = "ESTAS SEGURO QUE QUIERES ELIMINAR";
	if(confirm(mensaje)){
		window.location="bajapre.php?idac="+idac;
	}else{
...
<div id="templatemo_content">
  ...
  <br>
	...
	<center><table border="1" width=50% color=black >
		<tr>
		<td align=center><center><font size="4" color="#000000" face="Arial, Helvetica, sans-serif">CONSULTA ACCION PREVENTIVA</font></center></td>
		</tr>
        </table><br>
...
<?php
		...
		echo '<td align=center>';
		echo '<center><img src="imagenes/actions-delete.png" onclick="eliminar('.$row['idac'].')"/>';
		echo '</td>';
		echo '<td align=center>';
...
<?php 
echo "<td><b>";
echo $PAGINADOR->ver_pagina("consultapre.php");
echo "</td></b>";
?>
</div>
</tr>
